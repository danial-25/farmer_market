...
urlpatterns = [
    ...
    path('farmers/order/<int:order_id>/change-status/', views.ChangeOrderStatusView.as_view(), name='change_order_status'),
    path('buyers/order/history/', OrderHistoryView.as_view(), name='order-history'),
    path('farmers/orders/<int:order_id>/track/', OrderTrackingView.as_view(), name='farmer-orders'),
